  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> auth2ProfileUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final auth2ProfileUsersRecord = auth2ProfileUsersRecordList.isNotEmpty
            ? auth2ProfileUsersRecordList.first
            : null;
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CachedNetworkImage(
                                      ...
                                      fadeOutDuration:
                                          const Duration(milliseconds: 500),
                                      imageUrl:
                                          auth2ProfileUsersRecord!.photoUrl,
                                      width: 100.0,
                                      height: 100.0,
                                      fit: BoxFit.cover,
                                    ),
                    ...
                    Padding(
                      ...
                      child: Text(
                        valueOrDefault<String>(
                          auth2ProfileUsersRecord.displayName,
                          'Unknown',
                        ),
                          ...
                          context.pushNamed(
                            ...
                            queryParameters: {
                              'userDoc': serializeParam(
                                auth2ProfileUsersRecord,
                                ParamType.Document,
                              ),
                            }.withoutNulls,
                            extra: <String, dynamic>{
                              'userDoc': auth2ProfileUsersRecord,
